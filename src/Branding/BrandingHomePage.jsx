...
export default function BrandingHomePage() {
  return (
    <div className="flex flex-col xl:flex-row-reverse items-center xl:min-h-screen mb-5 xl:mb-0 mx-5 xl:mx-0">
      <motion.div
        className="flex flex-col items-center justify-center text-center p-8 xl:absolute xl:top-18/4 xl:left-1/7 xl:w-1/4 bg-base-200 rounded-4xl shadow-lg z-10 mb-5 xl:mb-0"
