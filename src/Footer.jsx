...
export default function Footer() {
    return (
        <footer className="bg-base-200 text-base-content p-4 w-full flex flex-col">
          <div className="flex flex-col justify-between md:flex-row text-left">
            <LBLogoFooter />
          <ul className="flex flex-col mt-5">
            <h1 className="text-2xl font-bold text-left ml-5">Contact Us</h1>
            <li className="text-md m-5 mb-0 flex flex-row">
            ...
            <li className="text-md m-5 mb-5 flex flex-row">
          ...
          <div className="flex flex-col mt-5">
            <h1 className="text-2xl font-bold ml-5">Find Us</h1>
          <div className="text-md m-5 mb-5 flex flex-row xl:mb-0">
