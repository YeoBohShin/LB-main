...
export default function ServicesHomePage() {
  return (
    <div className="flex flex-col xl:flex-row xl:min-h-screen text-center mx-5 items-center justify-start text-primary mb-5 xl:mb-0">
      <motion.div
        className="text-base-content bg-base-200 z-10 p-10 rounded-4xl shadow-lg relative flex flex-col justify-center items-center mt-5 xl:mt-0 xl:absolute xl:top-5/2 xl:right-1/7 max-w-md"
