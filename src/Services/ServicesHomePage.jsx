...
export default function ServicesHomePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-white mx-5 xl:mx-0">
      <motion.div className="text-center p-10 xl:absolute top-5/4 w-50% bg-base-200 xl:bg-[rgba(0,0,0,0.5)] rounded-4xl shadow-lg z-10"
